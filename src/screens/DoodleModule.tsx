...
export default function DoodleModule({ navigation, gestureManager, circles, image, paths, status, color, setColor, clear, resetImage, play, ...props }:any) {
    ...
    <>
        ...
        <View style={{ height, width }}>
            ...
            <View style={{ flex: 1, flexDirection: "row" }}>
                ...
                //     <Text style={styles.statusHeader}>Doodle Saved.</Text>
                //     {/* <Header>Doodle Saved.</Header> */}
                //     <View style={{flexDirection: 'row', marginVertical: 8}}>
                //         <Button mode="contained" onPress={playFn}>
                //             Create New Doodle
                //         </Button>
                //         <Button mode="outlined" onPress={playFn}>
                //             Exit
                //         </Button>
                //     </View>
                ...
                // </View> :
                <View style={styles.statusContainer}>
                    <Header>Saving image, please wait ...</Header>
                    <Text>Status: {status}</Text>
                </View>
                :
                ...
                <TouchableOpacity >
                    <Ionicons
                    name="images-outline"
                    onPress={() => {navigation.navigate('ExportableGallery'); clear()}}
                    style={styles.icon}
                    ></Ionicons>
                </TouchableOpacity>
