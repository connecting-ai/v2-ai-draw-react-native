...
export default function GuessAnimalScreen({ navigation }:any) {
  ...
  const fruits = ["Apple", "Apricot", "Avocado", "Banana", "Blackberry", "Blueberry", "Boysenberry", "Breadfruit", "Cantaloupe", "Cherimoya", "Cherry", "Clementine", "Coconut", "Cranberry", "Currant", "Date", "Dragonfruit", "Elderberry", "Feijoa", "Fig", "Gojiberry", "Gooseberry", "Grape", "Grapefruit", "Guava", "Honeydew", "Huckleberry", "Jackfruit", "Jambul", "Jujube", "Kiwi", "Kumquat", "Lemon", "Lime", "Loquat", "Lychee", "Mandarine", "Mango", "Mangosteen", "Melon", "Miraclefruit", "Mulberry", "Nectarine", "Orange", "Papaya", "Passionfruit", "Peach", "Pear", "Persimmon", "Pineapple", "Plum", "Pomegranate", "Pomelo", "Quince", "Raspberry", "Redcurrant", "Rhubarb", "Strawberry", "Tangerine", "Tangelo", "Tomato", "Ugli", "Watermelon", "Yuzu", "Acaiberry", "Akebia", "Aronia", "Bilberry", "Blackcurrant", "Cactusfruit", "Cloudberry", "Cocoplum", "Cranberry", "Cucumber", "Custardapple", "Damson", "Eggfruit", "Elderberry", "Feijoa", "Goumi", "Lemonadeberry", "Lingonberry", "Loquat", "Mulberry", "Nectarine", "Olive", "Rambutan", "Rosehip", "Saskatoonberry", "Starfruit", "Tamarillo", "Tamarind", "Yumberry"]
  ...
  async function start() {
    const keyword = fruits[Math.floor(Math.random() * fruits.length)];
    console.log(keyword)
    setKeyword(keyword)
    await play(keyword)
  }
  ...
  return (
    <Background>
      ...
      {/* <Logo /> */}
      <Header>What is this Fruit?</Header>
